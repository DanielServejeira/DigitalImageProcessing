...
begin
  for i:=1 to Image1.Width-1 do
    ...
    Grey := round(Image1.Canvas.Pixels[i,j+1]*2 + Image1.Canvas.Pixels[i-1,j+1] + Image1.Canvas.Pixels[i+1,j+1] -
            Image1.Canvas.Pixels[i,j-1]*2 - Image1.Canvas.Pixels[i-1,j-1] - Image1.Canvas.Pixels[i+1,j-1])/4;

    Image2.Canvas.Pixels[i,j] := RGB(Grey, Grey, Grey);
    end;
end;
...
begin
  for j:=1 to Image1.Height-1 do
    for i:=1 to Image1.Width-1 do
    begin
    Grey := round(Image1.Canvas.Pixels[i+1,j]*2 + Image1.Canvas.Pixels[i+1,j+1] + Image1.Canvas.Pixels[i+1,j-1] -
